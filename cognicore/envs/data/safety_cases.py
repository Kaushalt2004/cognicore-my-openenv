"""
Safety Cases Dataset — 30 AI safety evaluation cases across three difficulty levels.

Ported from the original ``env/dataset.py`` into the CogniCore framework.
Uses plain dataclasses instead of Pydantic for the package (zero-dep).
"""
